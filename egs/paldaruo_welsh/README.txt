...
About the Paldaruo Speech Corpus
--------------------------------

This is a Welsh language speech corpus that's been crowd sourced via the Paldaruo app. See:

http://langtech.wales/corpora/paldaruo/

The corpus is freely available under CC-BY license.

Scripta and instructions on its use in training Kaldi acoustic models can be found in the
s5 directory.
